...
| `Ram_CatSlot0_GridPos` | `$FFC3BE` |
| `Ram_CatSlot1` | `$FFC3C0` |
| `Ram_EnigmaBuffer` | `$FFC3E0` |
| `Ram_CatSlot1_GridPos` | `$FFC3FE` |
| `Ram_CatSlot2` | `$FFC400` |
| `Ram_CatSlot2_GridPos` | `$FFC43E` |
...
| `Ram_BonusCatInnerSlots` | `$FFC5C0` |
| `Ram_BonusCatOuterSlots` | `$FFC640` |
| `Ram_CatSlot3` | `$FFC680` |
| `Ram_CatSlot3_GridPos` | `$FFC6BE` |
| `Ram_CatSlot4` | `$FFC6C0` |
| `Ram_CatSlot4_GridPos` | `$FFC6FE` |
| `Ram_CatSlot5` | `$FFC700` |
| `Ram_CatSlot5_GridPos` | `$FFC73E` |
| `Ram_LizardRespawnSlot` | `$FFC740` |
| `Ram_SnakeRespawnSlot` | `$FFC7C0` |
...
| `Ram_LizardJumpVelX` | `$FFD26E` |
| `Ram_LizardJumpVelY` | `$FFD272` |
| `Ram_LizardJumpSpeed` | `$FFD276` |
| `Ram_ChickChainCount` | `$FFD27A` |
| `Ram_CutsceneFlag` | `$FFD27B` |
| `Ram_SnakeSpeed` | `$FFD27C` |
...
| `Ram_ChickMappingPtr` | `$FFD828` |
| `Ram_RoundNumber` | `$FFD82C` |
| `Ram_PlayerStartX` | `$FFD82E` |
| `Ram_PlayerStartY` | `$FFD82F` |
| `Ram_EntryArrowPos` | `$FFD830` |
| `Ram_CatDoorPos` | `$FFD832` |
| `Ram_ExitDoorGridX` | `$FFD834` |
| `Ram_ExitDoorGridY` | `$FFD835` |
| `Ram_Score` | `$FFD87E` |
| `Ram_Lives` | `$FFD882` |
