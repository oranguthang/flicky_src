...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Build Flicky ROM from assembly source')
    parser.add_argument('-s', '--source', default='flicky.s',
                        help='Source assembly file (default: flicky.s)')
