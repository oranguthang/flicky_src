...
Cat_StateFollowing_CheckDelivery:
                move.w  (sp)+,d1
                tst.b   (Ram_RoundEndingFlag).w
...
Cat_StateFollowing_DeliverDelay:
                move.l  a0,-(sp)
                moveq   #2,d1

Cat_StateFollowing_DelayLoop:
...
Cat_StateFollowing_CheckRoundEnd:
...
Cat_StateFollowing_SetFacing:
                btst    #0,d1
                bne.s   Cat_StateFollowing_SelectFrame
                bset    #7,2(a0)
                move.b  #1,$39(a0)

Cat_StateFollowing_SelectFrame:
                tst.b   d1
                bmi.s   Cat_StateFollowing_FrameUp
                move.w  #8,6(a0)
                bra.s   Cat_StateFollowing_Draw

Cat_StateFollowing_FrameUp:
                move.w  #4,6(a0)

Cat_StateFollowing_Draw:
                bsr.w   Anim_UpdateFrame
                bsr.w   Object_CalcScreenPos
                rts

Cat_ChainPositionPointers:  dc.b    0, 0
                dc.w    $D036, $D05E, $D086, $D0AE, $D0D6, $D0FE, $D126, $D14E
Cat_ChainDirectionPointers: dc.b    0, 0
...
Chick_DeliveryScoreTable:   dc.l    $100
                dc.l    $200
                dc.l    $300
                dc.l    $400
                dc.l    $500
                ...
                dc.l    $2000
                dc.l    $5000
Chick_PopupSlotTable:   dc.w    $C100, $C140, $C180, $C1C0, $C100, $C140, $C180, $C1C0
; Checks if chick chain hit by enemy
Chick_CheckEnemyHit:
                lea     (Ram_ProjectileSlots).w,a1
                moveq   #1,d0

Chick_CheckEnemyHit_Loop:
                move.w  d0,-(sp)
                btst    #1,5(a1)
...
Cat_StateWalking_SetFrame:
                move.w  #8,6(a0)

Cat_StateWalking_Move:
                bsr.w   Object_UpdatePosition
                tst.l   $2C(a0)
...
Cat_StateWalking_Stop:
                clr.l   $34(a0)
                move.w  #$C,$3C(a0)
                bra.s   Cat_StateWalking_Finish

Cat_StateWalking_AccelerateRight:
                addi.l  #$400,$34(a0)
                bra.s   Cat_CheckWallCollision
...
Cat_StateWalking_Finish:
                bra.s   Cat_StateWalking_Animate

Cat_StateWalking_Falling:
                move.w  $30(a0),d7
                move.w  $24(a0),d6
                bsr.w   Collision_GetTileAtPos
                tst.b   d4
...
Cat_StateWalking_KeepFalling:
                addi.l  #$1000,$2C(a0)
                move.w  #4,6(a0)

Cat_StateWalking_Animate:
                bclr    #7,2(a0)
                tst.l   $34(a0)
                bpl.s   Cat_StateWalking_Draw
                bset    #7,2(a0)

Cat_StateWalking_Draw:
                bsr.w   Anim_UpdateFrame
                bsr.w   Cat_CheckPlayerPickup
                rts

Cat_WalkSpeedTable: dc.l    $A000
                dc.l    $C000
                dc.l    $E000
                dc.l    $10000
                dc.l    $12000
...
Cat_StateWalkAlt_SetFrame:
                move.w  #8,6(a0)

Cat_StateWalkAlt_Move:
                bsr.w   Object_UpdatePosition
                tst.l   $2C(a0)
...
Cat_StateWalkAlt_Finish:
                bra.s   Cat_StateWalkAlt_Animate

Cat_StateWalkAlt_Falling:
                move.w  $30(a0),d7
                move.w  $24(a0),d6
                bsr.w   Collision_GetTileAtPos
                tst.b   d4
...
Cat_StateWalkAlt_KeepFalling:
                addi.l  #$1000,$2C(a0)
                move.w  #4,6(a0)

Cat_StateWalkAlt_Animate:
                bclr    #7,2(a0)
                tst.l   $34(a0)
                bpl.s   Cat_StateWalkAlt_Draw
                bset    #7,2(a0)

Cat_StateWalkAlt_Draw:
                bsr.w   Anim_UpdateFrame
                bsr.w   Cat_CheckPlayerPickup
                rts

Cat_WalkAltSpeedTable:  dc.l    $C000
                dc.l    $D000
                dc.l    $E000
                dc.l    $F000
                dc.l    $10000
