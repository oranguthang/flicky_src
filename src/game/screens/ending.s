...
Ending_StateWait_ClearPlaneLoop:
                move.w  #0,(a0)
                dbf     d0,Ending_StateWait_ClearPlaneLoop

Ending_StateWait_Return:
                rts
...
Ending_DrawCreditsLine_ClearRowLoop:
                move.w  #0,(VDP_DATA).l
...
Ending_CreditsLinePointers: dc.w    Ending_StaffText-Sys_GameEntryPoint
...
Obj_CreditsCharacter_Dispatch:
                move.w  $3C(a0),d0
                andi.w  #$7FFC,d0
                jsr     Ending_CreditsStateTable(pc,d0.w)
                rts

Ending_CreditsStateTable:
...
Obj_CreditsWait:
                move.b  (Ram_CreditsLine).w,d0
                cmp.b   $3A(a0),d0
                bne.s   Obj_CreditsWait_Return
                move.w  #4,$3C(a0)

Obj_CreditsWait_Return:
                rts
...
Ending_GraphicsMappingPointers: dc.w    Ending_GraphicsMap0-Sys_GameEntryPoint
                ...
                dc.w    Ending_GraphicsMap1-Sys_GameEntryPoint
Ending_GraphicsSizeTable:   dc.b    0, 3, 0, 3, 0, 4, 0, 2, 0, 4
