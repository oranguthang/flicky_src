...
Spawner_StateCountdown_Decrement:
                subq.w  #1,$38(a0)
                rts
...
Spawner_StateSpawn_ClearSprites:
                bsr.w   Sprite_ClearLinkTable

Spawner_StateSpawn_Return:
                rts

Spawner_AnimPointers:   dc.l    Spawner_AnimAppear
Spawner_AnimAppear:     dc.b    $1C, 4
...
Obj_ScorePopup_Countdown:
                bsr.w   Object_UpdatePosition
                subq.w  #1,$38(a0)
                bne.s   Obj_ScorePopup_Return
                clr.w   (a0)

Obj_ScorePopup_Return:
                rts

ScorePopup_MappingPointers: dc.w    ScorePopup_Map0-Sys_GameEntryPoint
...
Obj_ChickCountPopup_BelowDoor:
                add.w   d0,d6
                addq.w  #8,d6

Obj_ChickCountPopup_SetPosition:
                move.w  d6,$24(a0)
                move.w  #$1E,$38(a0)

Obj_ChickCountPopup_Countdown:
                bsr.w   Object_UpdatePosition
                subq.w  #1,$38(a0)
                bne.s   Obj_ChickCountPopup_Return
                clr.w   (a0)

Obj_ChickCountPopup_Return:
                rts

ChickCountPopup_MappingPointers:    dc.w    ChickCountPopup_Map0-Sys_GameEntryPoint
...
Obj_BonusScorePopup_Countdown:
                bsr.w   Object_UpdatePosition
                subq.w  #1,$38(a0)
                bne.s   Obj_BonusScorePopup_Return
                clr.w   (a0)

Obj_BonusScorePopup_Return:
                rts

BonusScorePopup_MappingPointers:    dc.w    ChickCountPopup_Map0-Sys_GameEntryPoint
                dc.w    ScorePopup_Map0-Sys_GameEntryPoint
                dc.w    ChickCountPopup_Map2-Sys_GameEntryPoint
                dc.w    ScorePopup_Map1-Sys_GameEntryPoint
                dc.w    ChickCountPopup_Map4-Sys_GameEntryPoint
