...
; The initial disassembly was produced with IDA Pro 7.6 SP1
                ...
                include "system/vectors_and_header.s"   ; $000000-$0001FF
                include "system/boot.s"                 ; $000200-$000401
                include "system/sega_screen.s"          ; $000402-$000855
                ...
                include "game/objects.s"                ; $01105C-$01130B
                include "game/camera_collision.s"       ; $01130C-$011421
                include "game/level.s"                  ; $011422-$011673
                include "game/scoring.s"                ; $011674-$0117BF
                include "game/collision_pairs.s"        ; $0117C0-$01190F
                include "rendering/level_draw.s"        ; $011910-$011BC1
                include "rendering/hud.s"               ; $011BC2-$011FAF
                include "game/title.s"                  ; $011FB0-$01228D
                include "game/guide.s"                  ; $01228E-$0125BD
                include "game/round_select.s"           ; $0125BE-$012655
                include "game/round_setup.s"            ; $012656-$012A93
                include "game/main_loop.s"              ; $012A94-$012F2F
                include "game/bonus.s"                  ; $012F30-$01310F
                include "game/ending.s"                 ; $013110-$0139A1
                include "game/demo.s"                   ; $0139A2-$013E6F
                include "game/player.s"                 ; $013E70-$0144DB
                include "game/chick.s"                  ; $0144DC-$01483D
                include "game/cat.s"                    ; $01483E-$014EC5
                include "game/lizard.s"                 ; $014EC6-$015507
                include "data/level_layout.s"           ; $015508-$015D57
                include "game/snake.s"                  ; $015D58-$016311
                include "game/spawner.s"                ; $016312-$0164EB
                include "game/bonus_objects.s"          ; $0164EC-$016DA9
                include "game/game_over.s"              ; $016DAA-$016E57
