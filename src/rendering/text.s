...
Gfx_DrawTilemapRect_RowLoop:
                move.l  d5,(a4)
                move.w  d7,d1

Gfx_DrawTilemapRect_ColumnLoop:
                move.w  (a6)+,(a3)
...
Text_DrawDoubleHeight_Return:
                rts

; Draws BCD number from (a6) with leading zero handling
Text_DrawBCDNumber:
                clr.b   (Ram_LeadingDigitSeen).w
                subq.w  #2,d5

Text_DrawBCDNumber_Loop:
                moveq   #0,d1
                move.b  (a6)+,d1
                move.w  d1,d4
                lsr.w   #4,d4
...
Text_DrawDigit_Return:
                rts

Text_DrawDigit_SeenNonZero:
