...
Gfx_InitTilemapGradient_RowLoop:
                move.w  d3,d2
                move.w  d4,d1
                moveq   #$20,d0
                add.w   d0,d3
...
Gfx_DrawTilemapRows_ColumnLoop:
                move.w  (a0)+,d1
                add.w   d3,d1
                move.w  d1,-4(a6)
...
Gfx_CopyToVRAM_BlockCheck:
                dbf     d1,Gfx_CopyToVRAM_Block8Loop
                andi.w  #7,d0
                bra.s   Gfx_CopyToVRAM_TailCheck

Gfx_CopyToVRAM_TailLoop:
                move.l  (a0)+,(a5)

Gfx_CopyToVRAM_TailCheck:
