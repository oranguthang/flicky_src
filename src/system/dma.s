...
Sys_LoadFuncTable:
                lea     Sys_FuncTable(pc),a0
                lea     (Ram_ExtIntTrampoline).w,a1
                move.w  (a0)+,d0

Sys_LoadFuncTable_Loop:
                move.w  #$4EF9,(a1)+
                moveq   #0,d1
                move.w  (a0)+,d1
                move.l  d1,(a1)+
                dbf     d0,Sys_LoadFuncTable_Loop
                rts

; Initializes RAM areas, VDP registers, checks console version
Sys_InitGameState:
                lea     (Ram_VDPRegisters).w,a6
                moveq   #0,d7
                move.w  #$13,d6

Sys_InitGameState_ClearVarsLoop:
                move.l  d7,(a6)+
...
Sys_InitGameState_ClearPaletteLoop:
                move.l  d7,(a6)+
...
Sys_InitGameState_WriteRegs:
                bsr.w   Gfx_WriteVDPRegs
                move.l  #$C0000000,(a6)
                move.w  #0,-4(a6)
                bra.w   Gfx_ClearSpriteArea

Sys_InitialStateValues: dc.w    $BE00, $B800, $B000, $C000, $E000, $40
...
Gfx_FillVRAMValue_BlockCheck:
                dbf     d1,Gfx_FillVRAMValue_Block8Loop
                andi.w  #7,d0
                bra.s   Gfx_FillVRAMValue_TailCheck

Gfx_FillVRAMValue_TailLoop:
                move.l  d3,(a5)

Gfx_FillVRAMValue_TailCheck:
