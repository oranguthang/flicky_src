...
Int_VBlankMain_ComparePaletteLoop:
                cmpm.l  (a0)+,(a1)+
...
Int_VBlankMain_PaletteChanged:
                move.b  #1,(Ram_PaletteDirty).w

Int_VBlankMain_TransferPalette:
                btst    #6,(IO_PCBVER+1).l
                beq.s   Int_VBlankMain_QueuePaletteDMA
                move.w  #$100,d0

Int_VBlankMain_DelayLoop:
                dbf     d0,Int_VBlankMain_DelayLoop

Int_VBlankMain_QueuePaletteDMA:
                move.w  #$F7E0,d1
                moveq   #0,d2
                move.w  #$80,d0
                jsr     j_Gfx_CopyToCRAM

Int_VBlankMain_EnableDisplay:
                move.w  #$8100,d0
